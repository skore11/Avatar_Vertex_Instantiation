...
public class GetBehaviors : MonoBehaviour {
    ...
    void Start()
    {
        ...
        //voxels in the character are now capable of performing any of the behaviors on command OR
        //on vicinity of said social environment

       
    }

    //TODO: simple GUI for selecting behaviors, trigger behavior in associated script on GUI button 
    //might have to use swith case
